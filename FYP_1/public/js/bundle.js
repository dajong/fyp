...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"registration.js":[function(require,module,exports) {
"use strict";
...
var register = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, name, role, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Registration successfully!');
            window.setTimeout(function () {
...
exports.bookTourWithStripe = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var bookTourWithStripe = /*#__PURE__*/function () {
  ...
  return function bookTourWithStripe(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.bookTourWithStripe = bookTourWithStripe;
